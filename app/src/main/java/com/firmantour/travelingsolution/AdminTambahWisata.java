...
public class AdminTambahWisata extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        if(filePath != null){
            ...
            Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(AdminTambahWisata.this, "Data berhasil disimpan", Toast.LENGTH_SHORT).show();
                    finish();
                }
            });
